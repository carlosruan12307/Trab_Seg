        ...
        return http
                ...
                .cors().configurationSource(new CorsConfigurationSource() {
                    ...
                    public CorsConfiguration getCorsConfiguration(HttpServletRequest arg0) {
                        ...
                        config.setAllowedOrigins(Arrays.asList("http://localhost:4200", "http://localhost:4500"));
                ...
                .requestMatchers(HttpMethod.POST, "/gerarOTP").permitAll()
                .requestMatchers(HttpMethod.POST, "/validarOTP").permitAll()
                .requestMatchers(HttpMethod.GET, "/pegarProdutoPeloNome").permitAll()
